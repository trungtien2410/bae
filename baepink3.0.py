...
class Worker13(QtCore.QThread):
    ...
    def run(self):
        try:
            ...
            final_grouped_ids_more_than_four = set() # Set lưu trữ tất cả các ID duy nhất thuộc về nhóm có từ 6 đến 9 ID
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.same_promotion_phone_btn = QtWidgets.QPushButton("Same Promotion + Phone Report")
        ...
        btn_layout_column1.addWidget(self.same_promotion_phone_btn)
        ...
        self.same_promotion_phone_btn_checkbox = QtWidgets.QCheckBox('Checked') #"Same Promotion + Phone Report"
        ...
        checkbox_layout_column1.addWidget(self.same_promotion_phone_btn_checkbox)
        ...
        self.same_phone_btn.setStyleSheet("color: black;")
        ...
        self.same_ip_create_time_district_city_state_btn = QtWidgets.QPushButton("Same IP and Create Time -6 Report")
        self.same_ip_create_time_district_city_state_btn.clicked.connect(self.same_ip_and_create_time_report)
        ...
        self.same_ip_create_reg_time_4_btn.setStyleSheet("color: black;")
        btn_layout_column3.addWidget(self.N3_btn)
        btn_layout_column3.addWidget(self.same_phone_btn)
        ...
        btn_layout_column3.addWidget(self.same_ip_create_reg_time_4_btn)

        checkbox_layout_column3 = QtWidgets.QVBoxLayout()
        self.N3_btn_checkbox = QtWidgets.QCheckBox('Checked') #"N3 Report"
        self.same_phone_btn_checkbox = QtWidgets.QCheckBox('Checked') #"Same Phone and District Report"
        ...
        self.same_ip_create_reg_time_4_btn_checkbox = QtWidgets.QCheckBox('Checked') #"Same IP and Create + RegTime 4 Report"
        checkbox_layout_column3.addWidget(self.N3_btn_checkbox)
        checkbox_layout_column3.addWidget(self.same_phone_btn_checkbox)
        ...
        checkbox_layout_column3.addWidget(self.same_ip_create_reg_time_4_btn_checkbox)
